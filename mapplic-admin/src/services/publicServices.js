...
async function addMap(name) {
    ...
    return axiosApiInstancePublic.post(
      `http://localhost:3004/create-map`,
      dataToSend
    ).then(response => {
        return response;
...
function uploadCapaImage(object_data){
  return axiosApiInstanceFormData.post(
      `http://localhost:3004/layer-image`,
      object_data
    )
    .then(response => {
      return response;
...
function uploadLocationImage(object_data){
  return axiosApiInstanceFormData.post(
      `http://localhost:3004/location-image`,
      object_data
    )
    .then(response => {
      return response;
