...
function useModal(parameters) {
  ...
  const isTopModal = React9.useCallback(() => manager.isTopModal(getModal()), [manager]);
...
var Slider = React51.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime33.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime32.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime32.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index2) => {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LQ7OKRD5.js.map
